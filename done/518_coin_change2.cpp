...
//
// was disqualified for bad performance :( needs memoization
class Solution2 {
private:
...
class Solution {
public:
    int dp[301][501];   // [demo] we limit 5000 to 500 coin values
                        // since some cpp compilers don't allow oversized arrays
                        // [wip] make this dynamically allocated?
